...
import validateTwoWayTrip from '../middlewares/validateReturnTrip';
...
const { getRequestStatus, markAsRead } = requestStatusController;

router.post('/trips/oneWayTrip', authCheck.auth, validateOneWayTrip, requestControllers.createOneWayTrip);
router.post('/trips/returnTrip', authCheck.auth, validateTwoWayTrip, requestControllers.createTwoWayTrip);
